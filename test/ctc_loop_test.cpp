...
void test_1()
{
   ...
   Interval fixed_point(0, 1), outer(0, 1.075);
...
void test_2()
{
   ...
   Interval fixed_point(0, 1), outer(0, 1.0095);
...
void test_3()
{
   ...
   Interval fixed_point(0, 1), outer(0, 1.0006);
...
{
   Problem prob;
   Variable x = prob.addRealVar(0, 10, "x"), y = prob.addRealVar(0, 10, "y");
