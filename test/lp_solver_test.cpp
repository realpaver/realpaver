...
void test_optimal_2()
{
   ...
   LinVar x1 = solver.makeVar(0.0, inf, "x1"),
          x2 = solver.makeVar(0.0, inf, "x2"),
...
void test_optimal_safe_2()
{
   ...
   LinVar x1 = solver.makeVar(0.0, ub, "x1"),
          x2 = solver.makeVar(0.0, ub, "x2"),
...
void test_bound_ctr()
{
   ...
   LinVar x1 = solver.makeVar(0.0, 5.0, "x1"),
          x2 = solver.makeVar(0.0, 10.0, "x2");
...
void test_infeasible_2()
{
   ...
   LinVar x1 = solver.makeVar(-inf, inf, "x1"),
          x2 = solver.makeVar(-inf, inf, "x2"),
          x3 = solver.makeVar(0.0, inf, "x2"),
          x4 = solver.makeVar(0.0, inf, "x2");
...
void test_model()
{
   ...
   LinVar x1 = solver.makeVar(2.0, 10.0, "x1"),
          x2 = solver.makeVar(0.0, 8.0, "x2"),
   ...
   IntervalVector C = solver.cost(),
                  Z = { Interval(-4.0), Interval(0.0), Interval(3.0) };
   ...
   IntervalVector B = solver.bounds(),
                  W = {Interval(2, 10), Interval(0, 8), Interval(-1, 5),
                       Interval::lessThan(14), Interval::positive(),
                       Interval::lessThan(2) };
