...
/*****************************************************************************
 * Wrapper for the gaol interval arithmetic library. The operations are either
 * delegated to gaol if they are available in this library or implemented.
 *****************************************************************************/
struct IntervalImpl {
   typedef gaol::interval interval;
   ...
   static inline interval minPX(const interval& x, const interval& y,
                                const interval& z)
   {
   ...
   static inline interval maxPX(const interval& x, const interval& y,
                                const interval& z)
   {
      if (x.is_empty() || y.is_empty() || z.is_empty())
         return interval::emptyset();
   ...
   static inline interval sgn(const interval& x)
   {
      if (x.is_empty())
         return interval::emptyset();
   ...
   static inline interval sgnPX(const interval& x, const interval& y)
   {
