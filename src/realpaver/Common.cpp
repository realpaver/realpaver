...
std::ostream &operator<<(std::ostream &os, OptimizationStatus status)
{
   ...
   case OptimizationStatus::StopOnIterLimit:
      return os << "StopOnIterLimit";
   case OptimizationStatus::StopOnTimeLimit:
      return os << "StopOnTimeLimit";
   case OptimizationStatus::StopOnNodeLimit:
      return os << "StopOnNodeLimit";
   case OptimizationStatus::Other:
      return os << "Other";
   default:
