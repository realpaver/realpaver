...
template <typename T> struct IntervalTraits {
   ...
   static interval addPX(const interval &x, const interval &y, const interval &z);
   static interval addPY(const interval &x, const interval &y, const interval &z);
   static interval addPZ(const interval &x, const interval &y, const interval &z);
   ///@}
   ...
   static interval subPX(const interval &x, const interval &y, const interval &z);
   static interval subPY(const interval &x, const interval &y, const interval &z);
   static interval subPZ(const interval &x, const interval &y, const interval &z);
   ///@}
   ...
   static interval mulPX(const interval &x, const interval &y, const interval &z);
   static interval mulPY(const interval &x, const interval &y, const interval &z);
   static interval mulPZ(const interval &x, const interval &y, const interval &z);
   ...
   static interval divPX(const interval &x, const interval &y, const interval &z);
   static interval divPY(const interval &x, const interval &y, const interval &z);
   static interval divPZ(const interval &x, const interval &y, const interval &z);
   ///@}
   ...
   static interval minPY(const interval &x, const interval &y, const interval &z);
   static interval minPZ(const interval &x, const interval &y, const interval &z);
   ///@}
   ...
   static interval maxPY(const interval &x, const interval &y, const interval &z);
   static interval maxPZ(const interval &x, const interval &y, const interval &z);
   ///@}
